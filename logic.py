...
class FinancialTracker:
    ...
    def _recalculate_daily_limits(self, start_date_str):
        ...
        This handles the rollover/deficit logic
        """
        ...
        while end_date is None or current_date < end_date:
            ...
            if daily_expenses <= running_limit:
                ...
                running_limit = initial_daily_limit + (running_limit - daily_expenses)
            else:
                # If spent more than limit, reduce next day's limit
                running_limit = initial_daily_limit - (daily_expenses - running_limit)
